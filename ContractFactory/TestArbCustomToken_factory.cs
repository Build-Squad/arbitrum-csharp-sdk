...
namespace Arbitrum.ContractFactory.TestArbCustomToken
{
    public partial class TestArbCustomTokenDeployment : TestArbCustomTokenDeploymentBase
    {
        public TestArbCustomTokenDeployment() : base(BYTECODE) { }
        public TestArbCustomTokenDeployment(string byteCode) : base(byteCode) 
        {
            BYTECODE = byteCode;
        }
    }

    public class TestArbCustomTokenDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public TestArbCustomTokenDeploymentBase() : base(BYTECODE) { }
        public TestArbCustomTokenDeploymentBase(string byteCode) : base(byteCode) { }
        [Parameter("address", "_l2Gateway", 1)]
        public virtual string L2Gateway { get; set; }
        [Parameter("address", "_l1Address", 2)]
    ...
    public partial class SomeWackyCustomStuffFunction : SomeWackyCustomStuffFunctionBase { }

    [Function("someWackyCustomStuff")]
    public class SomeWackyCustomStuffFunctionBase : FunctionMessage
    {
