...
namespace Arbitrum.DataEntities
{
    ...
    {
        // Ethereum addresses
        public const string NODE_INTERFACE_ADDRESS = "00000000000000000000000000000000000000C8";
        public const string ARB_SYS_ADDRESS = "0000000000000000000000000000000000000064";
        public const string ARB_RETRYABLE_TX_ADDRESS = "000000000000000000000000000000000000006E";
        public const string ARB_ADDRESS_TABLE_ADDRESS = "0000000000000000000000000000000000000066";
