        ...
        { 42161, new L2Network
            {
                ...
                PartnerChainID = 1,
                IsArbitrum = true,
                TokenBridge = new TokenBridge(), // Initialize with mainnet_token_bridge values
                EthBridge = new EthBridge(), // Initialize with mainnet_eth_bridge values
